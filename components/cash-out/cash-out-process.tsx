...
const steps = [
  {
    ...
    description: "No in-person appraisal needed for loans under $400K and prequalification won't affect your credit score. You'll immediately see your options.",
  },
  {
    number: "2",
    icon: CheckCircle,
  ...
  },
  {
    ...
    description: "Take advantage of the option to take additional draws as needed.",
  },
]

export function CashOutProcess() {
  return (
